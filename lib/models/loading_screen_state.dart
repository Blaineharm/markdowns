...
import 'package:markdowns/widget/loading_screen.dart';
import 'package:markdowns/models/message_state.dart';
...
class LoadingScreenState extends MessageState<LoadingScreen> {
  ...
  Future runInitTasks() async {
    ...
    Future.forEach(widget.initializers, (init) => init(this)).whenComplete(() {
      ...
      Post post = MyHomePageState.post;
      DepartmentModel departmentModel = MyHomePageState.departmentModel;


        MyHomePageState.markdownWebService(post,departmentModel);
